...
class SynteticInv:
    ...
    def plot_3d_slices(self, x_slices, y_slices, z_slices):
        ...
        fig.savefig("inv_cond_3d_slices.pdf")
        plt.show()
    ...
    def plot_results(self):
        ...
        #fig, ax = plt.subplots(1, len(y_slices), figsize=(20, 10))
    ...
    def save_inv(self):
        np.save("3d_synth_surf_inv_full", self.minv, allow_pickle=False)

    @inv.time_func
    def load_inv(self):
        self.minv =  np.load("3d_synth_surf_inv_full.npy", allow_pickle=False)
